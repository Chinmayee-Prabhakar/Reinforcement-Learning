...
def transition_values(state,action):
    ...
    elif new_state[0] == -1 or new_state[0] == grid_limits[0]+1:
        new_state = state
...
def get_output():
    ...
    for experiment in range(no_of_experiments):
        global Q_values
        if experiment in np.arange(0, no_of_experiments, no_of_experiments/6):
        ...
        for i in range(no_of_episodes):
            ...
            while not terminated:
                ...
                for ii in range(planning_step_index):
